---
title: RdsLogicalDatabase CRD schema reference (group xdatabase.crossplane.giantswarm.io)
linkTitle: RdsLogicalDatabase
description: |
  Custom resource definition (CRD) schema reference page for the RdsLogicalDatabase resource (rdslogicaldatabases.xdatabase.crossplane.giantswarm.io), as part of the Giant Swarm Management API documentation.
weight: 100
crd:
  claim_name: LogicalDatabaseClaim
  claim_name_plural: logicaldatabaseclaims
  default_composition_ref: logical-database
  enforced_composition_ref: logical-database
  name_camelcase: RdsLogicalDatabase
  name_plural: rdslogicaldatabases
  name_singular: rdslogicaldatabase
  short_names:
    - ld
  group: xdatabase.crossplane.giantswarm.io
  technical_name: rdslogicaldatabases.xdatabase.crossplane.giantswarm.io
  scope: 
...
aliases:
  - /reference/cp-k8s-api/rdslogicaldatabases.xdatabase.crossplane.giantswarm.io/
technical_name: rdslogicaldatabases.xdatabase.crossplane.giantswarm.io
source_repository: https://github.com/giantswarm/crossplane-gs-apis
source_repository_ref: main
---
...
<dd class="fullname">rdslogicaldatabases.xdatabase.crossplane.giantswarm.io</dd>
<dt class="claimname">Claim name:</dt>
<dd class="claimname">LogicalDatabaseClaim</dd>
<dt class="claimnamesplural">Claim plural names:</dt>
<dd class="claimnamesplural">logicaldatabaseclaims</dd>
<dt class="defaultcompositionref">Default composition ref:</dt>
<dd class="defaultcompositionref">logical-database</dd>
<dt class="enforcedcompositionref">Enforced composition ref:</dt>
<dd class="enforcedcompositionref">logical-database</dd>
<dt class="groupname">Group:</dt>
<dd class="groupname">xdatabase.crossplane.giantswarm.io</dd>
<dt class="singularname">Singular name:</dt>
<dd class="singularname">rdslogicaldatabase</dd>
<dt class="shortnames">Short Names</dt>
<dd class="shortnames">ld</dd>
<dt class="pluralname">Plural name:</dt>
<dd class="pluralname">rdslogicaldatabases</dd>
