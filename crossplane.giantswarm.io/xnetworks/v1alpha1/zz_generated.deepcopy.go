...
func (in *PeeredVpcNetworkStatus) DeepCopyInto(out *PeeredVpcNetworkStatus) {
	*out = *in
	...
	if in.Vpcs != nil {
		...
		*out = make(map[string]compositev1beta1.AwsVpc, len(*in))
		for key, val := range *in {
...
func (in *VpcPeer) DeepCopyInto(out *VpcPeer) {
	*out = *in
	in.ExcludeFromLocalPeering.DeepCopyInto(&out.ExcludeFromLocalPeering)
	if in.ExcludeFromRemotePeering != nil {
		in, out := &in.ExcludeFromRemotePeering, &out.ExcludeFromRemotePeering
