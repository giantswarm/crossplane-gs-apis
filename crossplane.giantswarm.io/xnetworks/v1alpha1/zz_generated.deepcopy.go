...
func (in *PeeredVpcNetworkStatus) DeepCopyInto(out *PeeredVpcNetworkStatus) {
	*out = *in
	...
	if in.SharedSubnets != nil {
		in, out := &in.SharedSubnets, &out.SharedSubnets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *TransitGatewayStatus) DeepCopyInto(out *TransitGatewayStatus) {
	*out = *in
	...
	if in.SharedPrefixLists != nil {
		in, out := &in.SharedPrefixLists, &out.SharedPrefixLists
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *WrappedVpcPeer) DeepCopyInto(out *WrappedVpcPeer) {
	*out = *in
	in.VpcPeer.DeepCopyInto(&out.VpcPeer)
}
